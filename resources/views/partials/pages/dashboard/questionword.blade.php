                                        ...
                                        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('/questionword/insert') }}" method="POST">
                                                            @csrf
                                                            ...
                                                            <label for="questionword" class="control-label">Kata Tanya</label>
                                                            <input type="text" placeholder="Kata Tanya" name="questionword" class="form-control input-sm">
                                                            <br>
                                                        </div>
                                                        <div class="modal-footer">
                                        ...
                                        deleteButtons.forEach(button => {
                                            button.addEventListener('click', function (event) {
                                                ...
                                                if (confirm('Anda Yakin menghapus data ini?')) {
                                                    fetch(`{{ url('/questionword/delete/') }}/${id}`, {
                                                        method: 'DELETE',
                                                        headers: {
